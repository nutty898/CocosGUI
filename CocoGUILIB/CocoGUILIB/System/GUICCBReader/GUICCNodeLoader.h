...
#define GUI_CCB_VIRTUAL_NEW_AUTORELEASE_CREATECCNODE_METHOD(T) virtual T * createCCNode(cocos2d::CCNode * pParent, cs::GUICCBReader * pCCBReader) { \
    return T::create(); \
}
    
#define GUI_CCB_PURE_VIRTUAL_NEW_AUTORELEASE_CREATECCNODE_METHOD(T) virtual T * createCCNode(cocos2d::CCNode * pParent, cs::GUICCBReader * pCCBReader) = 0
